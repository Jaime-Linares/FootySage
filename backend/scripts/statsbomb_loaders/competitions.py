...
def create_competition(competition_id, season_id, gender) -> None:
    '''
    Create a competition object in the database.
    params:
        competition_id: The ID of the competition to create.
        season_id: The ID of the season to create.
        gender: The genre of the competition to create.
    returns:
        None
    '''
    competitions = sb.competitions()
    competition = competitions[(competitions['competition_id'] == competition_id) & 
                                  (competitions['season_id'] == season_id) & 
                                  (competitions['competition_gender'] == gender)]
    ...
    #create_macthes_by_competition_id_and_season_id
    print(f"Competición {competition_data["competition_name"]} ({competition_data["season_name"]}) creada exitosamente.")
