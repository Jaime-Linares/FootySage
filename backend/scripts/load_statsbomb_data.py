...
COMPETITION_ID_1BUNDESLIGA = 1
SEASON_ID = 27


# information about competitions that is not included in Statsbomb but is necessary for the project
# statsbomb_id: { "api_id": <id de la API externa>, "competition_logo_url": <url of competition logo> }
competition_info = {
    ...
    COMPETITION_ID_1BUNDESLIGA: {                    # 1. Bundesliga
        "api_id": 78,
